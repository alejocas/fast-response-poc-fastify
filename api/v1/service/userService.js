const { loginUserSchema, registerUserSchema } = require('../model/user/userSchemas');
...
module.exports = (fastify, opts, next) => {
     ...
     * Register service
     */
    fastify.post('/register', registerUserSchema, async (req, reply) => {
     ...
     * Login service
     */
    fastify.post('/login', loginUserSchema, async (req, reply) => {
      const User = fastify.mongo.db.model('User')
